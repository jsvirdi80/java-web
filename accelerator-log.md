...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=jsvirdi80&repo=java-web",
  "projectName" : "tanzu-java-web-app",
  "repositoryPrefix" : "536248613663.dkr.ecr.ap-south-1.amazonaws.com/tap-images"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->536248613663.dkr.ecr...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=jsvirdi80&repo=java-web'
